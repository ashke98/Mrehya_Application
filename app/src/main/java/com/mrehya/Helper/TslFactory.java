...
/**
 * Created by hgjhghgjh on 10/20/2018.
 */

public class TslFactory extends SSLSocketFactory {

    private SSLSocketFactory delegate;

    public TslFactory() throws KeyManagementException, NoSuchAlgorithmException {
        SSLContext context = SSLContext.getInstance("TLS");
        context.init(null, null, null);
        delegate = context.getSocketFactory();
    }

    public TslFactory(TrustManager[] tm) throws KeyManagementException, NoSuchAlgorithmException {
        SSLContext context = SSLContext.getInstance("TLS");
