...
public class ListAdapterSimpleProvince extends BaseAdapter implements ListAdapter {
    ...
    public ListAdapterSimpleProvince(ArrayList<String> list, Context context, Activity activity, ListView listView) {
        this.list = list;
