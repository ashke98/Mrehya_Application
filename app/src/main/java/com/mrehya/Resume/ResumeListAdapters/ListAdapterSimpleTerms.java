...
public class ListAdapterSimpleTerms extends BaseAdapter implements ListAdapter {
    ...
    public ListAdapterSimpleTerms(ArrayList<String> list, Context context, Activity activity, ListView listView) {
        this.list = list;
