...
public class ListAdapterSimpleEducation extends BaseAdapter implements ListAdapter {
    ...
    public ListAdapterSimpleEducation(ArrayList<Education> list, Context context, Activity activity, ListView listView) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        txtEducationTitle.setTextSize(17);
        txtEducationCompany.setTextSize(15);
        txtEducationFrom.setTextSize(15);
        txtEducationTo.setTextSize(15);
