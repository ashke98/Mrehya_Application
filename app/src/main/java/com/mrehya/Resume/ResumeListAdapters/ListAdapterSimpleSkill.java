...
public class ListAdapterSimpleSkill extends BaseAdapter implements ListAdapter {
    ...
    public ListAdapterSimpleSkill(ArrayList<String> list, Context context, Activity activity, ListView listView) {
        this.list = list;
