...
public class ListAdapterProes extends BaseAdapter implements ListAdapter {
    ...
    public ListAdapterProes(ArrayList<String> list, Context context,Activity activity,ListView listView) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        btnEdit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                //do something
                showDialog(list.get(position),position);
                notifyDataSetChanged();
            }
        });
